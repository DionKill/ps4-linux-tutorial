...
| --------------------------------------------------------------------------------------------------------- | --------------------------------- | --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| [7.1.7](https://gitlab.com/rmuxnet/linux/-/releases/zaebiz%2F7.1.7-Stable)<br>*Recommended*                                | Aeolia, Belize                    | [GitHub](https://gitlab.com/rmuxnet/linux/)         | Upgrade to the 7.0 release.<br><br>- General (*recommended*)<br>- Server<br>- SlopMax (General with VM support)<br>- Slopium (Server with VM support) |
