...
| --------------------------------------------------------------------------------------------------------- | --------------------------------- | --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| [7.1.7](https://gitlab.com/rmuxnet/linux/-/releases/zaebiz%2F7.1.7-Stable)<br>*Recommended*                                | Aeolia, Belize                    | [GitLab](https://gitlab.com/rmuxnet/linux/)         | Upgrade to the 7.0 release.<br><br>- General (*recommended*)<br>- Server<br>- SlopMax (General with VM support)<br>- Slopium (Server with VM support) |
| **CURRENTLY DOWN**~~[7.0]~~(https://github.com/rmuxnet/linux/releases/tag/7.0-April-24)                                         | Aeolia, Belize<br>(Baikal is WIP) | [GitHub](https://github.com/rmuxnet/linux/)         | Port of 7.0 with loads of fixes                                                                                                                       |
| **CURRENTLY DOWN**~~[6.18.21]~~(https://github.com/rmuxnet/ps4-linux-12xx/releases/tag/6.18.21-April-3)                         | Aeolia, Belize                    | [GitHub](https://github.com/rmuxnet/linux/)         | Prebuilts are in the repo releases.                                                                                                                   |
...
| Kernel Download                                                         | Compatible Southbridges | Source Code                                         | Extra info                                                                             |
| ----------------------------------------------------------------------- | ----------------------- | --------------------------------------------------- | -------------------------------------------------------------------------------------- |
| **CURRENTLY DOWN**~~[7.0-Clean]~~(https://github.com/rmuxnet/ps4-linux-12xx)                  | Aeolia, Belize          | [GitHub](https://github.com/rmuxnet/ps4-linux-12xx) | Newer 7.0 server work by rmux.<br>Use the repo to pick the branch or release you want. |
| **CURRENTLY DOWN**~~[6.18.21]~~(https://github.com/rmuxnet/ps4-linux-12xx) <br> (Recommended) | Aeolia, Belize          | [GitHub](https://github.com/rmuxnet/ps4-linux-12xx) | Contains the Strawberry server prebuilts in the repo releases.                         |
