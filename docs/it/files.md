...
> [!WARNING]
> I'm sorry if some of the following links are sketchy, but the community is a divided mess unfortunately. Refer to the [Other Issues](docs/issues#other-issues) section for a rant.
## Kernels
...
[Credits for all of these kernels](docs/ending#credits).
...
If you have issues, remember to check the [Issues page](docs/issues).
### More kernels
...
If you want more kernels or help, ask out the [Discord servers](docs/revisions#important-places).
