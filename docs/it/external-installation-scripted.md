...
> [!TIP]
> If you have issues or just want to do manual partitioning (which often works better) try the [alternative installation here](docs/it/external-installation-manual.md).
...
> 
> You may have to use the [alternative method](docs/it/external-installation-manual.md).

- Type `install-psxitarch.sh`
	- If it fails, go to the [Installation Issues](docs/it/issues.md#installation-issues)
