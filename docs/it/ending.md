...
> [!TIP]
> I highly recommend continuing to the ["Post Installation" setup](docs/postinstall), to change language and download more RAM!

> [!NOTE]
> For any problems, [check the issues page](docs/issues)!
